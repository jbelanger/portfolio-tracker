...
namespace Portfolio.Infrastructure.DataMigrations
{
    ...
    [Migration("20240825025929_InitialMigration57")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.Domain.Entities.AssetHolding", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Portfolio.Domain.Entities.FinancialEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("MarketPricePerUnit")
                        .HasColumnType("decimal(18,8)");
            ...
            modelBuilder.Entity("Portfolio.Domain.Entities.FinancialTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Portfolio.Domain.Entities.PurchaseRecord", b =>
                {
                    ...
                    b.Property<long?>("AssetHoldingId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Portfolio.Domain.ValueObjects.PriceRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Portfolio.Domain.Entities.FinancialTransaction", b =>
                {
                    ...
                    b.OwnsOne("Portfolio.Domain.ValueObjects.Money", "FeeAmount", b1 =>
                        {
                            b1.Property<long>("FinancialTransactionId")
                                .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Portfolio.Domain.Entities.PurchaseRecord", b =>
                {
                    b.HasOne("Portfolio.Domain.Entities.AssetHolding", null)
