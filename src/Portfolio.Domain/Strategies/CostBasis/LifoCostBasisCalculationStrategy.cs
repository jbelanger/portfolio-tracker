...
namespace Portfolio.Domain.Strategies.CostBasis
{
    ...
    public class LifoCostBasisCalculationStrategy : ICostBasisCalculationStrategy
    {
        ...
        {
            // Sort the purchase records by purchase date in descending order to simulate LIFO
        ...
        /// <summary>
        /// Helper method to calculate the total cost from the sorted list of purchase records, using the LIFO strategy.
        /// </summary>
        /// <param name="sortedRecords">The list of purchase records sorted by purchase date in descending order.</param>
        /// <param name="tx">The financial transaction that disposes of the asset.</param>
        /// <returns>
